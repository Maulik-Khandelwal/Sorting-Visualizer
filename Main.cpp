...
public:
	SortingAlgorithms()
		: m_NewArrayButton(70, 20, 160, 30, "Generate new array"),
		m_SortButton(240, 20, 160, 30, "Sort!"),
		m_BubbleSortButton(450, 10, 160, 20, "Bubble sort", SortingAlgorithmFactory::Algorithm::BUBBLE_SORT),
		m_SelectionSortButton(620, 10, 160, 20, "Selection sort", SortingAlgorithmFactory::Algorithm::SELECTION_SORT),
		m_InsertionSortButton(790, 10, 160, 20, "Insertion sort", SortingAlgorithmFactory::Algorithm::INSERTION_SORT),
		m_MergeSortButton(960, 10, 160, 20, "Merge sort", SortingAlgorithmFactory::Algorithm::MERGE_SORT, Button::State::CHECKED),
		m_HeapSortButton(1130, 10, 160, 20, "Heap sort", SortingAlgorithmFactory::Algorithm::HEAP_SORT),
		m_QuickSortButton(450, 40, 160, 20, "Quick sort", SortingAlgorithmFactory::Algorithm::QUICK_SORT),
		m_GnomeSortButton(790, 40, 160, 20, "Gnome sort", SortingAlgorithmFactory::Algorithm::GNOME_SORT),
		m_CocktailSortButton(620, 40, 160, 20, "Cocktail sort", SortingAlgorithmFactory::Algorithm::COCKTAIL_SORT),
		m_BrickSortButton(960, 40, 160, 20, "Brick sort", SortingAlgorithmFactory::Algorithm::BRICK_SORT),
		m_CombSortButton(1130, 40, 160, 20, "Comb sort", SortingAlgorithmFactory::Algorithm::COMB_SORT),
